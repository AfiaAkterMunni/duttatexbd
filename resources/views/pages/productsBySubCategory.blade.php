...
<div class="flex flex-row">
        ...
        <ul class="show-dropdown">
            ...
            <li>
                <a href="{{ route('categories.show', ['slug' => $category->slug]) }}"
                    class="mx-[20px] text-[#9c9c9c] text-base py-4 px-4 block rounded relative transition-all hover:bg-sky-100 hover:text-gray-600 @if ($category->id == $subcategory->category->id) bg-sky-100 text-gray-600 @endif"
    ...
    <div class="lg:basis-4/5 basis-4/6">
        ...
        <div
            class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 py-10 lg:px-16 md:px-16 pr-14 pl-8 text-center uppercase text-lg">
        ...
        @else
        <div class="pt-12">
            <h6 class="text-3xl text-center text-gray-500">There is no product available in this subcategory!!!</h6>
        </div>
        @endif
    </div>
</div>
