                ...
                <div class="mt-8 mb-4 border-t pt-4">
                    ...
                    <label class="block text-md mb-6">
                        ...
                        <select
                            ...
                            <option value="index, all" @if($category->meta_robots == 'index, all') selected @endif>Index, All</option>
                            <option value="index, follow" @if($category->meta_robots == 'index, follow') selected @endif>Index, follow</option>
                            <option value="index, nofollow" @if($category->meta_robots == 'index, nofollow') selected @endif>Index, no-follow</option>
                            <option value="noindex, follow" @if($category->meta_robots == 'noindex, follow') selected @endif>No-index, follow</option>
                            <option value="noindex, nofollow" @if($category->meta_robots == 'noindex, nofollow') selected @endif>No-index, no-follow</option>
                            <option value="noodp, noydir" @if($category->meta_robots == 'noodp, noydir') selected @endif>Noodp, Noydir</option>
                        </select>
                        @error('meta_robots')
                            <p class="text-red-500 mt-4">{{$message}}</p>
                        @enderror
                    ...
                    <label class="block text-md mb-6">
                        ...
                        <input
                            class="block w-full mt-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Enter SEO Title" name="seo_title" value="{{ $category->seo_title }}"/>
                        @error('seo_title')
                            <p class="text-red-500 mt-4">{{$message}}</p>
                        @enderror
                    </label>
                    <label class="block text-md mb-6">
                        ...
                        <input
                            class="block w-full mt-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Enter H1 Text" name="h1_text" value="{{ $category->h1_text }}"/>
                        @error('h1_text')
                            <p class="text-red-500 mt-4">{{$message}}</p>
                        @enderror
                    </label>
                    <label class="block text-md mb-6">
                        ...
                        <textarea
                            class="block w-full mt-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Enter Meta Description" name="meta_description">{{ $category->meta_description }}</textarea>
                    ...
                    <label class="block text-md mb-6">
                        ...
                        <textarea
                            class="block w-full mt-2 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                            placeholder="Enter Meta Keywords" name="meta_keywords">{{ $category->meta_keywords }}</textarea>
                        @error('meta_keywords')
                            <p class="text-red-500 mt-4">{{$message}}</p>
                        @enderror
                    </label>
