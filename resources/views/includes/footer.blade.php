...
<div>
  ...
  <div class="md:flex md:flex-row mt-3 mb-1 mx-5">
    ...
    <div class="md:basis-1/2 text-center md:pt-0 pt-5">
      ...
      <a href="mailto:info@duttatex.com" class="mr-4" target="_blank"><ion-icon name="mail" class="md:size-3.5 size-4 rounded bg-sky-700 text-white md:p-0.5 p-1"></ion-icon></a>
...
<div class="fixed right-0 top-2/4 translate-y-[-50%]">
  ...
  <a href="mailto:info@duttatex.com" target="_blank" class="text-white bg-[#D74B40] block text-center p-3 text-lg hover:bg-black transition-all"><i class="fa fa-envelope"></i></a>
